            ...
            <ScrollView contentContainerStyle={QuotationFormStepStyle.scrollViewContent} showsVerticalScrollIndicator={false}>
                ...
                <View style={QuotationFormStepStyle.paperPage}>
                    ...
                    <View style={{ marginBottom: 15 }}>
                        ...
                        <Text style={{ fontFamily: "Montserrat_400Regular", fontSize: 7, color: '#000', textAlign: 'justify', marginBottom: 8, lineHeight: 11 }}>
                            We have multiple payment channels (BDO, GCASH, CC MAYA) with accounts names under M&RC TRAVEL AND TOURS and its owners, MR. RHON CARLE & MRS. MARICAR CARLE. Payments can only be paid directly to these accounts through online transfers, bank transfers, direct deposit or via credit card (via MAYA payment physical only with surcharge of <Text style={{ color: '#d32f2f', fontFamily: "Montserrat_700Bold", fontWeight: 'bold' }}>3.5%</Text>).
                        </Text>
                        <Text style={{ fontFamily: "Montserrat_400Regular", fontSize: 7, color: '#000', textAlign: 'justify', lineHeight: 11 }}>
                    ...
                    <View style={[QuotationFormStepStyle.row, { alignItems: 'flex-start', marginTop: 10 }]}>
                        <View style={{ flex: 1, paddingRight: 5 }}>
                            ...
                            <View style={[QuotationFormStepStyle.headerBlue, { marginTop: 0, marginBottom: 5 }]}>
                                <Text style={QuotationFormStepStyle.headerBlueText}>CANCELLATION POLICY</Text>
                            </View>
                            <Text style={{ fontFamily: "Montserrat_400Regular", fontSize: 7, textAlign: 'justify', marginBottom: 15, lineHeight: 10 }}>
                        ...
                        <View style={{ flex: 1, paddingLeft: 5, borderLeftWidth: 1, borderColor: '#ccc' }}>
                            ...
                            <View style={[QuotationFormStepStyle.headerBlue, { marginTop: 0, marginBottom: 5 }]}>
                                <Text style={QuotationFormStepStyle.headerBlueText}>PASSPORT & VISAS</Text>
                            </View>
