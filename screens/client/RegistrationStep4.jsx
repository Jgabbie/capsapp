                ...
                <View style={ModalStyle.modalOverlay}>
                    <View style={[ModalStyle.modalBox, { width: '90%', paddingHorizontal: 20, paddingVertical: 25 }]}>
                        ...
                        <ScrollView style={{ maxHeight: 400 }} showsVerticalScrollIndicator={false}>
                            <Text style={[ModalStyle.modalTextParagraph, { textAlign: 'justify', marginBottom: 12, lineHeight: 20 }]}>
                            ...
                            <Text style={[ModalStyle.modalTextParagraph, { textAlign: 'center', marginBottom: 15, lineHeight: 20 }]}>
                                Thank you for choosing our travel services. We look forward to providing you with an unforgettable travel experience!
                            </Text>

                            <Text style={[ModalStyle.modalTextParagraph, { textAlign: 'center', color: '#b54747', fontFamily: 'Montserrat_600SemiBold', fontSize: 11, marginBottom: 10 }]}>
                            ...
                            <Text style={[ModalStyle.modalTextParagraph, { textAlign: 'center', color: '#b54747', fontFamily: 'Montserrat_600SemiBold', fontSize: 11, marginBottom: 15 }]}>
