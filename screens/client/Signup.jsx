import { View, Text, TextInput, TouchableOpacity, Modal, ImageBackground, ToastAndroid, ActivityIndicator, ScrollView } from 'react-native'
    ...
    const validateField = (field, value) => {
        ...
        switch (field) {
            ...
            case "phonenum":
                ...
                else if (rawNum.length < 10) errorMsg = "Phone must be 10 digits";
                else if (!rawNum.startsWith("8") && !rawNum.startsWith("9")) errorMsg = "Number must start with 8 or 9";
                break;
            case "password":
