...
export default function PassportGuidanceNew() {
        ...
        const checkActiveApplications = async () => {
            ...
            try {
                ...
                const ongoingApp = data.find(app => {
                    ...
                    return app.applicationType === 'New Passport' && !terminalStatuses.includes(String(appStatus).toLowerCase());
                });
    ...
    const submitApplication = async () => {
        ...
        const hasAllDocuments = uploadedFiles.passportPhoto && uploadedFiles.applicationForm && 
                                uploadedFiles.psaBirthCertificate && uploadedFiles.validGovernmentId
                ...
                {checkingActive ? (
                    ...
                    <View style={[PassportGuidanceStyle.columnCard, { alignItems: 'center', paddingVertical: 40 }]}>
                        ...
                        <Text style={[PassportGuidanceStyle.subtitle, { textAlign: 'center', marginBottom: 24 }]}>
                            You currently have an ongoing New Passport application.
                        </Text>
                        <TouchableOpacity 
                    ...
                    <View style={PassportGuidanceStyle.columnCard}>
                        ...
                        <View style={{ marginTop: 40 }}>
                            ...
                            <Text style={PassportGuidanceStyle.subtitle}>Find answers to common questions about the new passport application process.</Text>
